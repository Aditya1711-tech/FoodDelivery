...
public class AuthController {
    ...
    public ResponseEntity<ResponseDTO<AuthResponseDTO>> registerUser(@RequestBody NewUserDTO newUserDTO) throws BaseException {
        UserDTO userDTO = authenticationService.addNewUser(newUserDTO);
        AuthRequestDTO authRequestDTO = new AuthRequestDTO();
        authRequestDTO.setEmail(newUserDTO.getEmail());
        authRequestDTO.setPassword(newUserDTO.getPassword());
